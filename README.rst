...
Tahoe-LAFS, or SimpleGeo's products. Currently only Python 3 is supported.

Please note that version 2.X is based on Python 2. Both Python 2 and 3 are
supported until version 3.3.6.
